...
int main (int argc, char *argv[]) {
	...
	string hrc (argv[3]);
	string dir;
	if(nd=="12")dir="./"+dirname+"/kcore_out/";
	else if(nd=="23")dir="./"+dirname+"/ktruss_out/";
	else if(nd=="34")dir="./"+dirname+"/base34_out/";
	string vfile = dir+gname + "_" + nd;
	string out_file;
	...
	fclose (fp);
	//ofstream p_file(string(filename)+"_ego_kcore.txt", std::ios::app);
	// ofstream p_file;
	// p_file.open("max_kcore.txt", std::ios::app);
	// p_file<<gname<<" maxK="<<maxK<<'\n';
