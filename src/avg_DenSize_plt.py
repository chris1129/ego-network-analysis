...
def avgDenSize(dir):
	filename=dir+"/avg_#DenSizeExcessThold.txt"
	...
	plt.ylabel('amount')
	plt.xlabel('avg_#DenSizeExcessThold (#Node with Dense>t&&Size>t/#Node)')
	title=dir[dir.rfind('/'):]
	plt.title(title+ "Dense>0.8, Size>10 ")
	plt.xticks(rotation=90)
	plt.tight_layout()
	plt.savefig(dir+'/avg_#DenSizeExcessThold.png',dpi=199)
